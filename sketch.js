...
function setup() {
  ...
  block25 = new Block(700,10,30,40);
  
  
rope=new Chain(ballPlay.body,{x:155,y:155});
...
{
  Matter.Body.setPosition(ballPlay.body,{x:mouseX,y:mouseY});
}
